      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto">
            Help us preserve and share the sacred stories of Christian martyrs
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-gold-400 pl-4">
                  ...
                  <p className="text-slate-300">
                    Fund the research and digital preservation of one martyr’s
                    complete biography and iconography.
                  </p>
                </div>
                <div className="border-l-4 border-crimson-400 pl-4">
                  ...
                  <p className="text-slate-300">
                    Support traditional iconographers in creating new sacred art
                    for our digital gallery.
                  </p>
                </div>
                <div className="border-l-4 border-emerald-400 pl-4">
                  ...
                  <p className="text-slate-300">
                    Sponsor educational programs that bring martyr stories to
                    schools and parishes worldwide.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="scroll-panel p-8">
              ...
              <p className="text-slate-300 leading-relaxed mb-4">
                ...
                very donation helps us continue our sacred work of preserving
                and sharing the testimonies of Christian martyrs through the
                beautiful tradition of Eastern Orthodox iconography.
              </p>
              <p className="text-slate-300 leading-relaxed">
                Your generosity ensures that these powerful stories of faith,
                courage, and sacrifice will inspire future generations of
